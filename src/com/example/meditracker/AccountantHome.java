...
public class AccountantHome extends Activity {
	Button Logout,Viewpatientdetails,addbill,update;
	SQLiteDatabase db;
    TextView gid;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		Logout.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				Intent ad= new Intent(AccountantHome.this,Login.class);
				startActivity(ad);
				finish();
			}
        	 });
		...
		addbill.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
	 			// TODO Auto-generated method stub
				Intent ad= new Intent(AccountantHome.this,AddBill.class);
				startActivity(ad);
			}
        	 });
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.accountant_home, menu);
		return true;
	}
